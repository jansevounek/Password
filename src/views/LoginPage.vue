<template>
    <div class="h-screen w-screen flex justify-center">
        <div class="w-screen mx-12 mt-20 h-72 text-white">
            ...
            <form action="">
                <input type="text" class="log-in-form" placeholder="Email" v-motion-slide-visible-once-left v-model="email" :class="isEmailValid === false ? 'wrong-email' : ''">
            ...
            <div class="relative w-[100%] flex justify-center">
                ...
                <button class="download-button w-[4.5rem] h-10" v-motion-slide-visible-once-right>Sign up</button>
            </div>
        </div>
    </div>
</template>
